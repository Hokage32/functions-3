...
fruits.forEach(function(e) {
  if(e.color === 'red'){
    ...
    console.log('The fruit with index of' + fruits.indexOf(e) + ' is an orange')
  }else{
    console.log('The fruit with index of' + fruits.indexOf(e) + ' is neither apple or orange')
  }
})
...
//The fruit with index of0 is neither apple or orange
//The fruit with index of1 is an orange
//The fruit with index of2 is neither apple or orange
//The fruit with index3is an apple.
...
// CODE HERE
const riceFood = foods.filter((e) => {
  return e.tags.includes('rice')
}).reduce((acc, cur) => {
